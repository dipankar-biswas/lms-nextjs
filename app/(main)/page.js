...
const HomePage = async() => {
  ...
  return (
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 grainy px-4 md:px-16 text-center">
        <div className="flex max-w-full flex-col items-center gap-4 text-center relative isolate">
          <div
            aria-hidden="true"
     ...
     <Element></Element>
      ...
      <section
        id="categories"
        className="space-y-6  py-8  md:py-12 lg:py-24  px-4 md:px-16"
      >
      ...
      {/* Courses */}
      <section id="courses" className="space-y-6   md:py-12 lg:py-24  px-4 md:px-16">
        <div className="flex items-center justify-between">
