...
const InstructorProfile = async ({ params: { id } }) => {
  ...
  return (
    <section id="categories" className="space-y-6  py-6  lg:py-12">
      <div className="grid grid-cols-12 lg:gap-x-8 gap-y-8 px-4 md:px-16">
        {/* Instructor Info */}
          ...
          <div className="bg-white rounded-2xl p-6 shadow">
            <div className="mb-6">
              <div className="w-36 h-36 rounded-full  mb-5 mx-auto overflow-hidden">
                <img
                  src={courseDetailsByInstructor?.profilePicture}
                  alt={courseDetailsByInstructor?.fullInName}
              ...
              <div>
                <h4 className="text-xl lg:text-2xl text-center">
                  {courseDetailsByInstructor?.fullInName}
                </h4>
